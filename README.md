...
| 🔍 [**sim-scout**](https://github.com/lonexreb/sim-scout) | Automated literature-to-simulation pipeline for automotive CFD — from published paper to benchmarked OpenFOAM simulation in hours, not weeks |
| 🏁 [**f1-design-ai**](https://github.com/lonexreb/f1-design-ai) | AI-assisted F1 car aerodynamic design pipeline — Blender parametric geometry + OpenFOAM CFD + ParaView analysis, orchestrated by OpenClaw |
...
| 🏥 [**clinical-trials-api**](https://github.com/lonexreb/clinical-trials-api) | ETL pipeline & REST API for ClinicalTrials.gov data — PostgreSQL, live on Render, built for OpenAlex integration |
| 📧 [**sdr-automation**](https://github.com/lonexreb/sdr-automation) | Multi-step agent pipeline for SDR research and outreach — YC AI Hackathon project, built on Zigsaw |
...
![OpenFOAM](https://img.shields.io/badge/OpenFOAM-1E88E5?style=flat)
